...
public class CustomHands : MonoBehaviour
{
    ...
    //{
    //    leftController.ControllerEnabled += Controller_ControllerEnabled;
    //    rightController.ControllerEnabled += Controller_ControllerEnabled;
    //}
    ...
    private void Controller_ControllerEnabled(object sender, ControllerInteractionEventArgs e)
    {
        ToggleVisibility();
    }
